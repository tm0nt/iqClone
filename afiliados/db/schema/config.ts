...
export const configs = pgTable("Config", {
  ...
  overlayBackdropColor: text("overlayBackdropColor").notNull().default("#0f172a"),
  ...
  overlayMutedTextColor: text("overlayMutedTextColor").notNull().default("#94a3b8"),
  ...
  inputBackgroundColor: text("inputBackgroundColor").notNull().default("#1a1a1a"),
  inputBorderColor: text("inputBorderColor").notNull().default("#2a2a2a"),
  inputLabelColor: text("inputLabelColor").notNull().default("#999999"),
  inputSubtleTextColor: text("inputSubtleTextColor").notNull().default("#666666"),
  ...
  loadingBackgroundColor: text("loadingBackgroundColor").notNull().default("#ffffff"),
  ...
  revShareFalsoValue: doublePrecision("revShareFalsoValue").notNull().default(85),
  ...
  valorMinimoDeposito: doublePrecision("valorMinimoDeposito").notNull().default(60),
  ...
  trackRegisterEvents: boolean("trackRegisterEvents").notNull().default(true),
  trackDepositEvents: boolean("trackDepositEvents").notNull().default(true),
  trackWithdrawalEvents: boolean("trackWithdrawalEvents").notNull().default(true),
  ...
  gatewayPixDepositoId: integer("gatewayPixDepositoId").references(() => gateways.id),
  gatewayPixSaqueId: integer("gatewayPixSaqueId").references(() => gateways.id),
  creditCardDepositId: integer("creditCardDepositId").references(() => gateways.id),
