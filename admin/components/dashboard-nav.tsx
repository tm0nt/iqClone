...
import {
  CreditCard, Home, Lock, Settings, Users, FileText,
  DollarSign, UserCog, IdCard, CandlestickChart, Megaphone,
} from "lucide-react"
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Transações", href: "/dashboard/transactions", icon: DollarSign },
      { title: "KYC", href: "/dashboard/kyc", icon: IdCard },
    ],
  },
  {
    label: "Sistema",
    items: [
      ...
      { title: "Administradores", href: "/dashboard/admins", icon: UserCog },
      { title: "Segurança", href: "/dashboard/security", icon: Lock },
      { title: "Paridades", href: "/dashboard/parities", icon: CandlestickChart },
      { title: "Promoções", href: "/dashboard/promotions", icon: Megaphone },
